...
""")
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["-f", str(taskfile), "--env", "staging", "run", "deploy"])
...
""")
        ...
        result = runner.invoke(
            main, ["-f", str(taskfile), "--env", "staging", "run", "deploy-exec"]
        )
...
""")
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["-f", str(taskfile), "run", "deploy"])
