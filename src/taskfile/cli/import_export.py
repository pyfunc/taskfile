...
@click.option(
    "--type",
    "source_type",
    type=click.Choice(["makefile", "github-actions", "gitlab-ci", "npm", "shell", "dockerfile"]),
    default=None,
...
@click.argument(
    "target_type", type=click.Choice(["makefile", "github-actions", "npm", "docker-compose"])
)
...
def detect():
    ...
    console.print(Panel.fit("[bold]Detected build configuration files:[/]", border_style="green"))
